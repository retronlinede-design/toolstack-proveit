...
const CATEGORY_DEFINITIONS = Object.freeze([
  ...
  ["attachment-proof-metadata", "Attachment and Proof Metadata"], ["sequence-group-coverage", "Issue Coverage"],
...
function auditCommon(record, collector) {
  ...
  if (!record.sequenceGroup) collector.add({ code: "RECORD_UNGROUPED", category: "sequence-group-coverage", severity: "information", record, field: "sequenceGroup", message: "Record is not assigned to an Issue." });
...
export function buildCaseAuditDocument(reportModel, definition, options = {}) {
  ...
  return createReportDocument({ definition, model, generatedAt, title: definition?.label || "Case Audit Report", summary, notices, sections: [
    ...
    { id: "sequence-group-coverage", heading: "Issue Coverage", type: "summary", metadata: sequenceGroupCoverage },
