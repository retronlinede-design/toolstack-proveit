...
import { readRescueSnapshotSummary } from "./rescueSnapshot.js";
...
export function getLocalStorageDiagnostics() {
  const rescueSummary = readRescueSnapshotSummary();

  return {
    quickCaptureCount: countQuickCaptures(),
    folderCount: countCaseFolders(),
    rescueSnapshotExists: rescueSummary.exists,
    rescueSnapshotTimestamp: rescueSummary.timestamp,
    rescueSnapshotCaseCount: rescueSummary.caseCount,
    rescueSnapshotFolderCount: rescueSummary.folderCount,
    rescueSnapshotImageCount: rescueSummary.imageCount,
  };
}
